function [dfx,dfy, img ] = fresnel_cov(dx,dy, r, obj, z )
...
pha_obj = exp(1i*pi/z/r.*q_pha_obj); % exp(j*k/2/z*(x^2+y^2))
pha_img = exp(1i*pi/z/r.*q_pha_img); % exp(j*k/2/z*(fx^2+fy^2))
